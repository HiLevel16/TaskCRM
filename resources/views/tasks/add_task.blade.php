...
<div class="row mt-1">
    <div class="col-md-12 col-md-offset-1">
        <div class="card">
            <form method="POST" action="{{ route('task.addPost') }}">
                ...
                <table style="margin-bottom: 0" class="table table-striped task-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                              <input name="title" type="text" class="form-control" placeholder="Task title" value="{{session('title') ?? ''}}">
                            </td>
                        </tr>
                        <tr>
                            <td class="align-middle">
                            ...
                            <td>
                              <textarea name="description" class="form-control" aria-label="description">{{session('description') ?? ''}}</textarea>
                            </td>
                        </tr>
                        <tr>
                            <td class="align-middle">
                            ...
                            <td>
                                <div class="input-group">
                                  ...
                                  <input name="amount" type="text" class="form-control" aria-label="...">
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input id="payment" type="hidden" name="payment_type" value="{{$paymentSystems[0]->id}}">
                            </td>
                        </tr>
                        <tr>
                            <td class="align-middle">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input id="category" type="hidden" name="category" value="{{$categories[0]->id}}">
                            </td>
                        </tr>
                        <tr>
                            <td>
